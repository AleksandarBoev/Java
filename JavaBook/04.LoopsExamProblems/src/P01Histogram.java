...
public class P01Histogram {
    public static void main(String[] args) {
        ...
        System.out.printf("%.2f%%%n", percentage1); //dava limit pamet na nulevite testove
        System.out.printf("%.2f%%%n", percentage2); //moje da se opravi kato System.out.printf se zameni sus System.out.println
